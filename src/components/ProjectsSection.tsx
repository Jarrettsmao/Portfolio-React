...
const projects = [
...

    {
        ...
        description: "Social deduction game with 8 player network capability, designed with fun weapons and gadgets.",
...

    {
        ...
        description: "3D Exploration game using creative lighting, creepy SFX, and particle effects.",
    ...
    <section id="projects" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                Here are some of my recent projects. While not all of them are perfect,
                I strive to continue building upon each project to deliver better and more interesting creations in the future.
            </p>
                ...
                {projects.map((project, key) => (
                    ...
                    >
                        ...
                        <div className="p-6 flex flex-col flex-grow">
                            ...
                            <h3 className="text-xl font-semibold mt-2 text-center">{project.title}</h3>
